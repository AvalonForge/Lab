<template lang="html">
  <article class="font-sans">
    ...
    <p>
      ...
      Donec molestie condimentum justo, eu convallis lacus sodales ut. Phasellus
      auctor id purus sed aliquam.
    </p>
    <p>
      Praesent viverra magna vitae lacus tempor imperdiet. Suspendisse
    ...
    <p>
      ...
      nibh sed est. Nullam felis lorem, lacinia non consectetur id, consectetur
      a lectus.
    </p>
    <ul>
      <li>Ut pellentesque</li>
      <li>leo euismod</li>
      <li>varius quam id</li>
      <li>dictum nisl</li>
    </ul>
    <p>
      Fusce vitae mauris suscipit, <strong>eleifend ex eu</strong>, ornare
    ...
    <blockquote>
      ...
      Vivamus pretium blandit fringilla. Aenean et massa urna. Phasellus ac nunc
      tortor. Morbi nec leo non turpis ultrices commodo. Nam quam eros, dictum
      eget consequat eget, mattis vitae lacus. In vestibulum lorem magna, eu
      gravida tellus malesuada sed. Vestibulum maximus at nunc vel eleifend.
    </blockquote>
    <p>
      In vitae magna orci. Vivamus in nulla quis leo commodo bibendum id vitae
      risus. Nam at dolor rhoncus, venenatis nunc non, placerat sem. Phasellus
      malesuada luctus nunc nec dignissim.
    </p>
  </article>
</template>
